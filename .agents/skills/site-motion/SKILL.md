...
Load gsap-core/gsap-react for implementation, gsap-scrolltrigger/gsap-plugins for scrolling and masks, gsap-timeline when sequencing is useful, and gsap-performance for relevant diagnostics. Use animate/better-ui for refinement within this contract. Do not require gallery research, extra engines, SplitText, Flip or a separate header/hero timeline to start the site.
