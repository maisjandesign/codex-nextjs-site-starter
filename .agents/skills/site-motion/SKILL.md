---
name: site-motion
description: Implement required GSAP ScrollSmoother, masked entrances and shared interaction motion during desktop website work, with token consistency and visible fallbacks.
---

# site-motion

Read [MOTION-DEFAULTS.md](../../../docs/MOTION-DEFAULTS.md) at startup. Implement GSAP ScrollSmoother and masked text/content/media entrances as required defaults. Preserve native reduced-motion/touch scrolling and visible SSR content; do not add first-screen parallax. Load gsap-plugins and gsap-scrolltrigger for smoother integration. Missing or unobserved defaults block completed desktop handoff.
