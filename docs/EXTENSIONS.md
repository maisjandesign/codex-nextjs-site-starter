...
The template includes 28 local skills: ten site-* workflow skills, eleven original design/motion skills, six official GSAP skills and Graft, with available supporting files. Use [SKILL-ROUTING.md](SKILL-ROUTING.md) at startup for the required stage map and conflict rules. These eleven are already bundled, not optional future installations.
