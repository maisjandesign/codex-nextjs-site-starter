...
| Character    | Fit and motion direction                                                                                     | Optional additions                                                            |
| ------------ | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
| Editorial    | Architecture, editorial, professional brands: clear line reveals, restrained image masks, deliberate spacing | Native scrolling normally suffices                                            |
| Portfolio    | Agencies, designers, visual work: coordinated hero, connected card/detail transitions, distinctive galleries | Lenis only if smoothing improves the observed interaction                     |
...
GSAP + ScrollTrigger are the installed base. SplitText and Flip ship in the installed GSAP package and are used by the starter. Read official [SplitText](https://gsap.com/docs/v3/Plugins/SplitText/) and [Flip](https://gsap.com/docs/v3/Plugins/Flip/) docs for the current APIs. Motion and Anime.js remain alternatives after project analysis; do not add duplicate engines for the same work.

[Lenis](https://github.com/darkroomengineering/lenis) is optional: coordinate it with ScrollTrigger, configure anchors and nested scrolling, and test route changes/reduced motion. Use one scroll smoothing system. Mobile smoothing is a separate decision during authorized adaptation.
